"""
Django settings for lowcode_backend project.
...
SECRET_KEY = 'django-insecure-tcezlo$9$=_#7lm^q*4azi2m-pd31!+&n)eic_yiferndfzw8#'
...
ROOT_URLCONF = 'lowcode_backend.urls'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=15),  # Access token lasts 15 minutes
